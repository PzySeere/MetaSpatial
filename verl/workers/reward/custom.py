...
from ...utils.reward_score import math_compute_score, r1v_compute_score, metaverse_compute_score
...
class CustomRewardManager:
    def __init__(self, tokenizer: PreTrainedTokenizer, num_examine: int, compute_score: str):
        ...
        elif compute_score == "metaverse":
            self.compute_score = metaverse_compute_score
        else:
